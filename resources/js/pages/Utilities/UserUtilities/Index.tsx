...
import { ChevronRight, CornerDownRight, UserCog } from 'lucide-react';
                ...
                <Card className="border shadow-none">
                    <CardHeader>
                        <div className="space-y-1">
                            <h1 className="text-xl font-semibold">User Utilities</h1>
                            <p className="text-muted-foreground text-sm">‣ Manage user-related utilities and configurations</p>
                        </div>
                    </CardHeader>
                                ...
                                <Card className="group-hover:border-primary h-full transition-all duration-200 hover:shadow-sm">
                                    <CardContent className="flex h-full flex-col p-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-muted-foreground mt-1 text-sm">‣ Manage user roles.</p>
                                        </div>
                                    </CardContent>
                                </Card>
                            </Link>
